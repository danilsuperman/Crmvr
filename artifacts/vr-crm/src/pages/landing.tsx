...
import {
  ...
  ChevronDown, Twitter, Github, MessageSquare,
} from "lucide-react";

// ─── HELPERS ──────────────────────────────────────────────────────────────────

function GlowButton({ children, variant = "primary", className = "", onClick }: { children: React.ReactNode; variant?: "primary" | "secondary" | "ghost"; className?: string; onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className={cn(
  ...
  return (
    <div className="bg-[#0a0c16]/90 border border-white/10 rounded-2xl p-5 backdrop-blur-xl">
      ...
      <div className="flex items-end gap-1 h-20 mb-3">
        {bars.map((h, i) => (
          <div key={i} className="flex-1 rounded-sm transition-all" style={{ height: `${h}%`, backgroundColor: i === 4 ? "#6366f1" : i === 8 ? "#8b5cf6" : `rgba(99,102,241,${0.2 + (h / 100) * 0.4})` }} />
        ))}
      </div>
    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-[#070910]/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <GlowButton variant="secondary" className="hidden sm:inline-flex text-xs px-4 py-2">Демо</GlowButton>
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 md:px-6 pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Scan line */}
        <div className="absolute left-0 right-0 h-px bg-gradient-to-r from-transparent via-indigo-500/30 to-transparent" style={{ animation: "scanline 8s linear infinite", top: "0%" }} />
      </div>
      ...
      <div className="relative max-w-7xl w-full mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <GlowButton variant="secondary" className="px-8 py-3.5 text-base">
              Смотреть демо
  ...
  const features = [
    {
      ...
      items: ["Realtime-сетка броней", "Карта парка", "Мультизоны", "Онлайн-оплата"],
    },
    {
      icon: Cpu,
      title: "VR-шлемы",
      ...
      items: ["Telemetry", "Запуск игр", "Streaming", "Remote control"],
    },
    {
      icon: Globe,
      ...
      items: ["VR-конструктор", "Пакеты", "AI рекомендации", "Embed виджет"],
    },
    {
      icon: BarChart3,
      title: "Аналитика",
      ...
      items: ["Загрузка", "Выручка", "Популярность игр", "Воронка броней"],
    },
    {
      icon: Layers,
      ...
      items: ["Multi-location", "Роли сотрудников", "Устройства", "Финансы"],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          {features.map((f) => (
            <div
              key={f.title}
              className="group relative bg-white/3 hover:bg-white/6 border border-white/8 hover:border-white/15 rounded-2xl p-5 transition-all duration-500 cursor-default overflow-hidden"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Следите за всеми зонами, запускайте игры,
              контролируйте устройства, видьте проблемы
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 space-y-3">
            ...
            <div className="bg-[#0a0c16]/90 border border-white/10 rounded-2xl p-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                {[
                  { icon: Play, label: "Запуск", color: "text-green-400" },
                  { icon: Eye, label: "Stream", color: "text-indigo-400" },
                  { icon: RotateCcw, label: "Reboot", color: "text-yellow-400" },
                  { icon: MessageSquare, label: "Msg", color: "text-violet-400" },
                ].map((a) => (
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Pico 4, Quest 3, PSVR2 — все устройства под контролем.
              Запускайте игры, смотрите стрим, управляйте батареями.
            </p>
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Gamepad2, text: "Запуск любой игры удалённо" },
                { icon: Radio, text: "Live streaming с шлема" },
                { icon: Battery, text: "Battery & telemetry" },
                { icon: MessageSquare, text: "Overlay сообщения" },
                { icon: RotateCcw, text: "Remote reboot" },
                { icon: Eye, text: "Мониторинг контента" },
              ].map((item) => (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto mt-4">
            Три режима бронирования в одном виджете — автоматический, ручной и пакетный.
            Встраивается на любой сайт.
          </p>
        </div>
            ...
            {[
              {
                ...
                color: "indigo",
                desc: "CRM задаёт 5 вопросов и предлагает идеальный вариант для группы",
              },
              {
                icon: Layers,
                label: "Собрать вручную",
                color: "violet",
                desc: "Как Steam — клиент выбирает зоны, игры и время шаг за шагом",
              },
              {
                icon: Package,
                label: "Выбрать пакет",
                color: "pink",
                desc: "Готовые пакеты Birthday, Corporate, Tournament, Full Park",
              },
            ].map((mode, i) => (
              <div key={mode.label} className="flex gap-4 p-4 rounded-2xl border border-white/8 bg-white/3 hover:bg-white/6 hover:border-white/15 transition-all group cursor-default">
                <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center shrink-0",
                  mode.color === "indigo" ? "bg-indigo-500/20 border border-indigo-500/30" :
                  mode.color === "violet" ? "bg-violet-500/20 border border-violet-500/30" :
    ...
    <section className="relative py-24 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-[#0a0c16]/90 border border-white/10 rounded-2xl p-5">
          ...
          <div className="space-y-2">
            {[
              { time: "16:00", a: "Arena A", b: "Racing Zone", c: "VR Solo", d: "PS5" },
              { time: "17:30", a: "Racing Zone", b: "Arena A", c: "PS5", d: "VR Solo" },
              { time: "19:00", a: "Arena B", b: "VR Solo", c: "Arena A", d: "Racing Zone" },
            ].map((row) => (
              <div key={row.time} className="flex gap-2 items-center">
                ...
                {[row.a, row.b, row.c, row.d].map((zone, i) => (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Не скучные таблицы. Живые графики, heatmaps,
              воронки броней и инсайты о каждой зоне.
            </p>
            <div className="grid grid-cols-2 gap-3">
              {[
    ...
    <section className="relative py-24 px-4 md:px-6">
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-white/60 text-lg max-w-2xl mx-auto mb-12">
          Одна панель для всей сети. Единая аналитика, сотрудники, устройства и финансы.
        </p>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="bg-white/3 border border-white/8 rounded-xl p-3">
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      {["Arena A", "VR Solo", "PS5", "Racing"].map((z, i) => (
                        <div key={z} className={cn("rounded-lg p-1.5 text-center text-[8px] font-semibold border", i % 2 === 0 ? "bg-indigo-500/15 border-indigo-500/25 text-indigo-300" : "bg-white/3 border-white/8 text-white/30")}>
                          {z}
                        </div>
                      ))}
                    </div>
          ...
          <div>
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Полноценный мобильный интерфейс. Всё что нужно —
              у вас в кармане, где бы вы ни находились.
            </p>
...
function IntegrationsSection() {
  const integrations = [
    { name: "Pico 4", type: "VR", icon: "🥽" },
    { name: "Quest 3", type: "VR", icon: "🎮" },
    { name: "PSVR2", type: "VR", icon: "🕹️" },
    { name: "Telegram", type: "Notify", icon: "✈️" },
    { name: "SMS", type: "Notify", icon: "💬" },
    { name: "Webhooks", type: "API", icon: "🔗" },
    { name: "REST API", type: "API", icon: "⚡" },
    { name: "YooMoney", type: "Оплата", icon: "💳" },
    ...
    <section className="relative py-24 px-4 md:px-6">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-white/60 text-lg max-w-xl mx-auto mb-12">
          Pico, Quest, SMS, Telegram, API, платёжные системы — всё работает из коробки
        </p>
    ...
    <section className="relative py-24 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 max-w-2xl mx-auto">
          {[
            { value: "47+", label: "парков в системе" },
            { value: "99.8%", label: "uptime" },
            { value: "1.2M+", label: "сеансов контролировано" },
  ...
  const plans = [
    {
      ...
      price: "4 900",
      period: "/ мес",
      desc: "Для небольших парков до 6 зон",
      color: "border-white/10",
      cta: "Начать бесплатно",
      features: ["До 6 зон", "2 пользователя", "Online booking", "Базовая аналитика", "Email поддержка"],
      featured: false,
    },
    {
      name: "Pro",
      price: "14 900",
      period: "/ мес",
      desc: "Для среднего парка с командой",
      color: "border-indigo-500/50",
      cta: "Попробовать Pro",
      features: ["Неограничено зон", "10 пользователей", "Управление шлемами", "Расширенная аналитика", "Telegram/SMS", "Приоритетная поддержка"],
      featured: true,
    },
    {
      name: "Network",
      price: "По запросу",
      period: "",
      desc: "Для сетей от 3+ парков",
      color: "border-white/10",
      cta: "Обсудить",
      features: ["Все парки", "Неограничено пользователей", "Единая аналитика сети", "Кастомный брендинг", "API", "Выделенный менеджер"],
      featured: false,
    },
  ];
    ...
    <section className="relative py-32 px-4 md:px-6 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-white/60 max-w-2xl mx-auto leading-relaxed mb-10">
          От бронирования до управления устройствами —
          вся инфраструктура VR-парка в одной системе.
        </p>
...
function Footer() {
  const cols = [
    {
      title: "Продукт",
      links: ["Возможности", "Цены", "Интеграции", "Changelog"],
    },
    {
      title: "Компания",
      links: ["О нас", "Контакты", "Партнёрам", "Карьера"],
    },
    {
      title: "Ресурсы",
      links: ["Документация", "API Reference", "Поддержка", "Статус"],
    },
    {
      title: "Legal",
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center font-bold text-white text-sm shadow-[0_0_15px_rgba(99,102,241,0.4)]">V</div>
              <span className="font-bold text-white">VR Park OS</span>
            </div>
            <p className="text-xs text-white/40 leading-relaxed mb-4">
              Операционная система для современных VR-парков
            </p>
            <div className="flex gap-2">
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#070910] text-white overflow-x-hidden">
      ...
      <HeroSection onEnterApp={goToApp} />
      <FeaturesSection />
      <LiveOpsSection />
      <DeviceSection />
